...
public class EnviarCorreo {
    ...
    public EnviarCorreo(String host, int port, String username, String password) {
        prop = new Properties();
...
//        message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("buzon.bodeco.des@correo.gob.es"));
