...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.me.App=");
    idx += (13 + "me.App".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/me.App/_sourcemap.json 
//# sourceURL=me.App-0.js
